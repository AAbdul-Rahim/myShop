...
<nav class="sidebar-wrapper">
    ...
    <div class="sidebar-menu-wrapper">
        <ul>
            ...
            <li>
                <a href="myOrder.php?benim=<?= $row['userID']?>">
                    <i class="fa fa-boxes"></i>
                    <span>My Orders</span>
                </a>
            </li>
            <li>
                <a href="trackProduct.php?benim=<?= $row['userID']?>">
                    <i class="fa fa-boxes"></i>
            ...
            <li>
                <a href="transaction.php?benim=<?= $row['userID']?>">
            ...
            <h5>product info</h5>
            <li>
                <a href="addProduct.php?benim=<?= $row['userID']?>">
                    <i class="fa fa-plus-square"></i>
                    <span>add products</span>
                </a>
                </li>
            <li>
                <a href="allProducts.php?benim=<?= $row['userID']?>">
