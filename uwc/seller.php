    ...
    if (isset($_POST['submit'])){
        ...
        if ($inputPassword !== $confirmPass){
            ...
            $update = mysqli_query($connect, "UPDATE users SET  firstName = '$inputFirstName',lastName = '$inputLastName'
                 ,userEmail = '$inputEmail',gender = '$inputGender',userType = '$userType',sellerStatus = 'pending', userPhone = '$inputPhone',
                 country = '$country', userPassword = '$inputPassword' WHERE userID = '$userID' ");

            if($update){

                array_push($errors, '.');

                echo "<script>alert('Request To Become A Seller Successfully');</script>";
                echo "<script>window.location='login-register.php'</script>";

            }
            else{

                array_push($errors, 'Sorry Request To Be Seller Not Successfully. try again!');
            }
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-content-wrapper">
                <h2 class="main-title">become a seller</h2>
                        ...
                        <form action="" method="POST" class="admin-form w-75">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="userType" id="formInput" value="seller" readonly>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <input type="submit" name="submit" id="formSubmit" value="send request" required>
                                    </div>
                                </div>
                            </div>
