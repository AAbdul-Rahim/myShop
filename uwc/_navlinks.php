        ...
        ?>
            <div class="cart-icon order-md-last">
                ...
                if(!empty($_SESSION["userCart"])) {
                    ...
                    $cart_count = count(array_keys($_SESSION["userCart"]));
                    ?>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu mini-menus">
                        ...
                        <a class="dropdown-item mini-menus-links" href="userCheckout.php?benim=<?= $userID ?>"><i class="fa fa-shopping-cart"></i>check out</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item mini-menus-links" href="logout.php?benim=<?= $userID ?>"><i class="fa fa-power-off"></i>logout</a>
                    </div>
                </li>
            </ul>
        </div>
