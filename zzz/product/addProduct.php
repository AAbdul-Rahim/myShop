    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-content-wrapper">
                <form action="submit.php" enctype="multipart/form-data" class="addProductForm" method="post">
                    <h1 class="main-wrapper-title">add products</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                <textarea name="productDesc" id="" rows="5" placeholder="Product Desc"></textarea>
                            </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <input type="submit" name="insert" id="" value="add product">
                            </div>
                        </div>
                    </div>
                </form>
