...
if (isset($_POST['insert'])) {
    ...
    if ($fileCount > 5) {
        ...
        if ($productCat === 'cloths') {
            ...
            $productInsert = mysqli_query($connect, "INSERT INTO products(productID,productName,productPrice,productQty,
        ...
        elseif ($productCat === 'phone-tablet') {
            ...
            $productInsert = mysqli_query($connect, "INSERT INTO products(productID,productName,productPrice,productQty,
                                     ...
                                     VALUES('$productID','$productName','$productPrice','$productQty','$productCat','$productType',
